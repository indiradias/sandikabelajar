    ...
    <center>
        ...
        <tr>
            <table width="625" class="border-bottom border-dark solid"><br>
                <td><img src="{{ asset('public/PPDB/images/logo ppm.png')}}" width="105" height="105"></td>
                <td>
                    <center class="">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                <td class="text"><br>
                    {{-- <img src="{{ asset('storage/' . $siswa->pasphoto) }}" width="279" height="381"> --}}
                    <img src="{{ asset('/public/storage/app/public/' . $siswa->pasphoto) }}" width="80" height="120">
                </td>
            </div>
        </div>
