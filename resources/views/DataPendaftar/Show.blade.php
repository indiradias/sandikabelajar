                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->pasphoto) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->akta_peserta) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->ktp_orangtua) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->kartu_keluarga) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->raport) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ asset('storage/' . $siswa->sertifikat_prestasi) }}" class="btn btn-xs btn-secondary">Show File</a>
                                </div>
                            </div>
                        </div>
                    </div>
